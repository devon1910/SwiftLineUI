    ...
    <footer className="bg-gray-50 border-t border-gray-200 mt-auto">
      ...
      <div className="bg-black text-white py-3">
        <div className="container mx-auto px-4 text-center text-xs">
          ...
          <p className="mt-2">© {new Date().getFullYear()} <span className="font-bold">Swiftline</span>. All rights reserved. Created by <a href="https://davidson-portfolio-davidsons-projects-2757da45.vercel.app/" target="_blank">Davidson Ekpokpobe</a></p>
        </div>
      </div>
    </footer>
  );

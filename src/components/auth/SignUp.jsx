...
const SignUp = ({ setShowAuthModal }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const signUpRequest = { email, password, fullName, turnstileToken, hasAgreedToTermsOfServiceAndPrivacyPolicy };
      ...
      {isFormSubmitted ? (
        ...
        >
          ...
          <div>
            ...
            <button
              onClick={() => {
                /* Optionally reset form or navigate */ setShowAuthModal(null);
              }}

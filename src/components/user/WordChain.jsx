    ...
    <div className="max-w-md mx-auto rounded-xl shadow-2xl overflow-hidden border border-gray-200">
      ...
      {gameState === "menu" && (
        <div className="p-6 text-center">
          <div className="mb-6">
            <div className="w-24 h-24 bg-gradient-to-br from-sage-500 to-sage-600 rounded-full mx-auto mb-4 flex items-center justify-center">
            ...
            <div className="bg-green-250 border border-sage-200 rounded-lg p-3 mb-4">
          ...
          {highScore > 0 && (
            <div className="bg-sage-50 border border-green-200 rounded-lg p-3 mb-6">
          ...
          <button
            onClick={startGame}
            className="bg-gradient-to-r from-sage-600 to-sage-700 text-white px-8 py-3 rounded-lg font-semibold hover:from-sage-700 hover:to-sage-800 transition-all duration-200 flex items-center gap-2 mx-auto"
          >

    ...
    <div className=" p-4 rounded-lg shadow border">
      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          <thead className="bg-sage-50 dark:bg-gray-400">
            <tr>
              <th className="px-4 py-3 text-left">Metric</th>
              <th className="px-4 py-3 text-left">This Event</th>
              <th className="px-4 py-3 text-left">Avg. Across Events</th>
          ...
          <tbody>
            <tr>
              ...
              <td className="px-4 py-3">{"avgMetrics.avgServiceTime"} min</td>
              <td className="px-4 py-3">{"bestMetrics.avgServiceTime"} min</td>
            </tr>
            <tr>
              ...
              <td className="px-4 py-3">{"avgMetrics.dropOffRate"}%</td>
              <td className="px-4 py-3">{"bestMetrics.dropOffRate"}%</td>
            </tr>
            <tr>
              <td className="px-4 py-3">Peak Hour</td>
              <td className="px-4 py-3">{"currentEventMetrics.peakHour"}</td>

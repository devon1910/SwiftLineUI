...
//Events
export const eventsList = (page, eventsPerPage, search="") => API.get(apiUrl + "Event/SearchEvents?page="+page+"&size="+eventsPerPage+"&query="+search);
export const createEvent = (event) => API.post(apiUrl + "Event/CreateEvent", event);
export const eventQueueInfo = (eventId) => API.get(apiUrl + "Event/GetEventQueue/" + eventId);
